...
<head>
    ...
    <style>
        .bg-image {
            ...
            background-image: url('../assets/img/4073764-lambo.jpg');
            height: 100vh;
        }
    </style>
...
<body class="bg-image">
    ...
    <div class="container mt-3">
        ...
        while ($row = mysqli_fetch_array($album)) { ?>
            <a href="home.php?albumid=<?php echo $row['albumid'] ?>" class="btn btn-danger"><?php echo $row['namaalbum'] ?></a>
...
<footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
        <p>&copy; UKK RPL 2024 | Joean Oliver</p>
    </footer>
